...
public class MaxLengthWordsFilterMapperTest {

    private final static MaxLengthWordsFilterMapper MAX_LENGTH_WORDS_FILTER_MAPPER = new MaxLengthWordsFilterMapper();
    ...
    @Before
    public void before() {
        mapDriver = MapDriver.newMapDriver(MAX_LENGTH_WORDS_FILTER_MAPPER);
        mapDriver.clearInput();
    }

    @Test
    public void shouldFilterWordsWithMaxLength() throws URISyntaxException {
        URL resource = MaxLengthWordsFilterMapperTest.class.getResource("/part-r-00000");
        mapDriver.addCacheFile(resource.toURI());
